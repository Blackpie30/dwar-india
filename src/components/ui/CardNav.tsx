...
export const CardNav: React.FC<CardNavProps> = ({
  ...
  return (
    <div className={`card-nav-container ${className}`} style={style}>
      <nav
        ref={navRef}
        ...
        <div className="card-nav-top">
          ...
          <div className="logo-container">
            {typeof logo === "string" ? (
              ...
              <span className="card-nav-logo-text">DWAR INDIA</span>
            )}
          </div>
          ...
          <button
            ...
            onClick={
              ...
              (() =>
                window.open(
                  "https://wa.me/919828123281?text=Namaste%20Dwar%20India,%20I%20want%20to%20inquire%20about%20stone%20door%20frames.",
                  "_blank"
                ))
            }
